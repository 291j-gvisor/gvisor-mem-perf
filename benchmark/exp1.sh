...
nice -20 taskset 0x1 python3 run_mmap_warmuptrail.py --runtime=runsc-dev --iterations=100000
#
...
nice -20 taskset 0x1 python3 run_mmap_warmuptrail.py --runtime=runsc-dev --iterations=250000
#
...
nice -20 taskset 0x1 python3 run_mmap_warmuptrail.py --runtime=runsc-dev --iterations=500000

# for shared or private
#nice -20 taskset 0x1 python3 run_mmap_warmuptrail.py --runtime=runc --iterations=10000
#nice -20 taskset 0x1 python3 run_mmap_warmuptrail.py --runtime=runsc-kvm --iterations=10000
#nice -20 taskset 0x1 python3 run_mmap_warmuptrail.py --runtime=runsc-dev --iterations=10000

#nice -20 taskset 0x1 python3 run_mmap_warmuptrail.py --runtime=runc --iterations=25000
#nice -20 taskset 0x1 python3 run_mmap_warmuptrail.py --runtime=runsc-kvm --iterations=25000
#nice -20 taskset 0x1 python3 run_mmap_warmuptrail.py --runtime=runsc-dev --iterations=25000

#nice -20 taskset 0x1 python3 run_mmap_warmuptrail.py --runtime=runc --iterations=5000
#nice -20 taskset 0x1 python3 run_mmap_warmuptrail.py --runtime=runsc-kvm --iterations=5000
#nice -20 taskset 0x1 python3 run_mmap_warmuptrail.py --runtime=runsc-dev --iterations=5000
