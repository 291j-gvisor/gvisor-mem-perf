...
./run_mmap.py --runtime=runc --iterations=100000 --warmup=200000
./run_mmap.py --runtime=runsc-kvm --iterations=100000 --warmup=200000

./run_mmap.py --runtime=runc --iterations=250000 --warmup=200000
./run_mmap.py --runtime=runsc-kvm --iterations=250000 --warmup=200000

./run_mmap.py --runtime=runc --iterations=500000 --warmup=200000
./run_mmap.py --runtime=runsc-kvm --iterations=500000 --warmup=200000
#
